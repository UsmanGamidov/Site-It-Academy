    ...
    try {
      ...
      await api.post(
        "/applications",
        {
          ...
          phone: form.phone,
          courseId: course._id,
          message: course.title + ".  " + form.message,
          userId: userId,
        },
        {
          headers: {
    ...
    <div className="course-landing">
      ...
      <div className="course-benefits">
        <div className="benefit">
          ...
          <p>Решите реальные задачи от компаний-партнёров</p>
        </div>
        <div className="benefit">
          <div className="icon">[+]</div>
          <p>Сертификат и диплом по окончании курса</p>
        </div>
        <div className="benefit">
          <div className="icon">[+]</div>
          <p>Подходит новичкам без опыта в IT</p>
        </div>
        <div className="benefit">
          <div className="icon">[+]</div>
          <p>5 проектов в портфолио</p>
        </div>
      </div>
